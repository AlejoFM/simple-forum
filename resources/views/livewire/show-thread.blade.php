<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="rounded-md bg-gradient-to-r from-slate-800 to-slate-900 mb-4">
        <div class="p-4 flex gap-4">
            ...
            <div class="w-full">
                <h2 class="mb-4 items-start justify-between">
    ...
    <form wire:submit.prevent="postReply">
        <input type="text" placeholder="Escribe una respuesta" class="mb-4 bg-slate-800 border-0 rounded-md w-full p-3 text-white/60 text-xs" wire:model="body" >
    </form>
</div>
